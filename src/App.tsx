      ...
      <Tabs.Root defaultValue="1">
        <Tabs.List className={styles.list}>
          <div className={styles.scroller}>
            ...
            <Tabs.Trigger value="7" className={styles.trigger}>
              <span className={styles.label}>Tab example</span>
              <Button>
                <KebabIcon />
              </Button>
            </Tabs.Trigger>
            <Tabs.Trigger value="8" className={styles.trigger}>
              <span className={styles.label}>Tab example</span>
              <Button>
                <KebabIcon />
              </Button>
        ...
        <Tabs.Content value="7" className={styles.content}>
          Tabs 6
        </Tabs.Content>
        <Tabs.Content value="8" className={styles.content}>
          Tabs 6
        </Tabs.Content>
      </Tabs.Root>
    </React.Fragment>
